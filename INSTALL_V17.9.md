# Cài bản cập nhật Royal content groups V17.9
...
unzip -o "$HOME/Downloads/japan-app-royal-content-groups-v17.9-code-only.zip" -d .
grep -n "royal-content-groups-v17.9" src/components/ui/RoyalPositioning.ts
npx tsc --noEmit
