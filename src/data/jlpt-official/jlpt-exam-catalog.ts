...
const incompleteSourceIds = new Set<string>([scannedSourceIds[0], scannedSourceIds[1], scannedSourceIds[2], scannedSourceIds[3], scannedSourceIds[4], scannedSourceIds[5], scannedSourceIds[6], scannedSourceIds[7]]);
