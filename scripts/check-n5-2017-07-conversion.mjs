...
const sourcePromptAnchors = new Map([
  ['n5-2017-07-grammar-reading-p1-q1', '日本'],
  ['n5-2017-07-grammar-reading-p1-q2', 'きょうだい'],
  ['n5-2017-07-grammar-reading-p1-q3', '山下'],
  ['n5-2017-07-grammar-reading-p1-q6', 'パーティー'],
  ['n5-2017-07-grammar-reading-p2-q3', '会社'],
  ['n5-2017-07-grammar-reading-p3-q1', '［22］'],
  ['n5-2017-07-grammar-reading-p4-q3', '森さん'],
  ['n5-2017-07-grammar-reading-p5-q1', 'こまりましたか'],
]);
const seen = new Set();
