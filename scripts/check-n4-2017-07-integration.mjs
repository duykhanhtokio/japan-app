...
assert.doesNotMatch(catalog,/n4-2017-07-exam-06/);
assert.equal(hash('assets/jlpt/n4/2017-07/audio/n4-2017-07.mp3'),manifest.runtimeAudio.sha256);
console.log('N4 2017-07 INTEGRATION AUDIT PASS: 69 written and 28 listening responses audited; explanations/translations absent; 28 timings remain candidate_unverified; exam is incomplete and not structured_ready.');
