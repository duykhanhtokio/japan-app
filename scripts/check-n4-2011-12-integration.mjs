...
assert.match(catalog, /'n4-2011-12'/);
assert.match(catalog, /incompleteSourceIds\.has\(sourceId\) \? 'incomplete' : 'scanned_only'/);
assert.doesNotMatch(catalog, /n4-2011-12-exam-01/);
...
console.log('N4 2011-12 INTEGRATION AUDIT PASS: 70 written and 27 listening responses inventoried; source components recorded; exam remains incomplete and is not structured_ready.');
