...
assert.match(catalog,/'n4-2013-12'/);
assert.doesNotMatch(catalog,/n4-2013-12-exam-04/);
assert.equal(hash('assets/jlpt/n4/2013-12/audio/n4-2013-12.mp3'),manifest.runtimeAudio.sha256);
console.log('N4 2013-12 INTEGRATION AUDIT PASS: 70 written and 28 listening responses audited; 28 timings remain candidate_unverified; exam is incomplete and not structured_ready.');
