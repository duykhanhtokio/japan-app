...
const expectedKeys = [1, 2, 3, 4, 2, 1, 1, 3, 1, 2, 2, 4, 3, 4, 1, 2, 3, 4, 3, 4, 2, 3, 2, 1, 4, 1, 4, 1, 3, 2, 4, 3, 2, 1, 4, 1, 4];
...
console.log('N1 2015-12 RECOVERY PASS: pages 2-4 questions 1-37; four options each; unique IDs; 37/37 keys match 70-entry declaration; cross-page mapping and source hashes match');
