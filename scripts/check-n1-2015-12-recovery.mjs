...
const expectedKeys = [1, 2, 3, 4, 2, 1, 1, 3, 1, 2, 2, 4, 3, 4, 1, 2, 3, 4, 3, 4, 2, 3, 2, 1, 4, 1, 4, 1, 3, 2, 4, 3, 2, 1, 4, 1, 4, 2, 4, 3, 2, 1, 3, 1];
...
for (let index = 0; index < records.length; index += 1) {
  ...
  if ([42, 43, 44].includes(questionNumber) && JSON.stringify(record.sourcePages) !== JSON.stringify([4, 5])) {
...
console.log('N1 2015-12 RECOVERY PASS: pages 2-5 questions 1-44; four options each; unique IDs; 44/44 keys match 70-entry declaration; cross-page mappings and source hashes match');
