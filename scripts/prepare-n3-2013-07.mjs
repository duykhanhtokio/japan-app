...
import content from './n3-2013-07-written-content.mjs';

const source=fs.readFileSync('src/data/jlpt-mock/n3-2013-07-official.ts','utf8');
...
const dir='docs/jlpt-workspace/conversion/n3-2013-07';fs.mkdirSync(dir,{recursive:true});
