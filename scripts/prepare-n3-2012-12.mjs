...
import content from './n3-2012-12-written-content.mjs';

const source=fs.readFileSync('src/data/jlpt-mock/n3-2012-12-official.ts','utf8');
...
const audio='assets/jlpt/n3/2012-12/audio/n3-2012-12.mp3';
...
const dir='docs/jlpt-workspace/conversion/n3-2012-12';fs.mkdirSync(dir,{recursive:true});
