...
- Six image-choice listening questions are temporarily represented by text descriptions of the source images; five more listening questions have contextual source illustrations that are not yet attached to the runtime. Those descriptions are explicitly marked as candidates and require image-level review before claiming exact visual fidelity. The PDF page itself is not shown as a question.
