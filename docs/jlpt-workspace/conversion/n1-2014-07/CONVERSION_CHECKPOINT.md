...
- Codex-authored translation question 3: cumulative 36/840 targets, all 12 locales for each completed question. The distinction between 濃縮 and 凝縮 and both source entries marked “no such word” are retained. All metadata remains AI/unreviewed; no external translation service was used. Durable commit: pending remote verification. Next: question 4 onward after this unit is pushed, fetched and exact-HEAD verified.
