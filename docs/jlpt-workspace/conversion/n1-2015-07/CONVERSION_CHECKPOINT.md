# N1 2015-07 written-only conversion checkpoint

- Exam ID: `n1-2015-07-exam-07`.
- Scope: written questions only. Listening is `DEFERRED_UNVERIFIED`; do not process audio, timecodes, listening scripts, or reviews.
...
- Status: `WRITTEN_IN_PROGRESS` (34/70, with question 29 blocked). This is not full-exam `structured_ready`.

Next: validate and durably persist questions 31–35, then continue source transcription from question 36. Keep question 29 `BLOCKED_SOURCE_UNREADABLE`; do not revisit it in this session. Do not process listening.
