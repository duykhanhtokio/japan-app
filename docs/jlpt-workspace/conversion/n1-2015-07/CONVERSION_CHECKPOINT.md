...
Next: keep question 29 `BLOCKED_SOURCE_UNREADABLE`; do not infer it from the answer key. Recover the next available source-backed explanation/translation unit for the 106 assembled response units while leaving N1 07/2015 pending and all listening timing candidate/unverified. Do not register the incomplete candidate or change the locked UI.
