...
- `written.partial.json` contains 20 source-page-reviewed written responses (overall numbers 1–10, 19–26, 29–30). These are not a playable exam yet.
- The source packet has 65 written and 24 listening positions and a printed answer key. Forty-five written prompts/options and all 24 listening question presentations remain to be transcribed.
