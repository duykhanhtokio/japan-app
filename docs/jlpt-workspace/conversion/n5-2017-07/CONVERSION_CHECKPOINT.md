...
- `written.partial.json` contains 35 uniquely mapped, source-page-reviewed written responses (including vocabulary and grammar questions through source page 17). These are not a playable exam yet.
- The source packet has 65 written and 24 listening positions and a printed answer key. Thirty written prompts/options and all 24 listening question presentations remain to be transcribed.
