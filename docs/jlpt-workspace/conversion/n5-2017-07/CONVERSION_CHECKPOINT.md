...
- The source packet has 65 written and 24 listening positions and a printed answer key. Six visually similar spelling/kanji written prompts/options and 13 listening question presentations remain to be transcribed.
...
- 11 short-response listening questions were transcribed from printed transcript pages 47–49. Playback remains a single continuous MP3; no per-question audio cuts.
